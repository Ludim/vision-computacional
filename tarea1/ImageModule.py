...
class ImageModule:
    def __init__(self,image):
        ...
        self.archivoInput = open("input.txt", "w") # escala de gris
        self.archivoOutput = open("output.txt", "w") # matriz cuando se le aplica un operador
    ...
    def grayScale(self):
        ...
        self.newImag.save("testGray", self.imag.format)
    ...
    def negative(self):
        ...
        self.newImag.save("negative",self.imag.format)
        print("Negative Done...")
        ...
        for x in range(self.width):
            for y in range(self.height):
                ...
                if(tag=="red"):
                    ...
                    blue=value[2]
                    self.newImag.putpixel((x,y),(red,green,blue))
        self.newImag.save("test"+tag+"",self.imag.format)
        print("Done...")
        self.imprimirMatrizSalida()
    ...
    def contrast(self):
        ...
        self.newImag.save("testContrast1",self.imag.format)
        print("Done...")
        self.imprimirMatrizSalida()
    ...
    def mirrorHorizontal(self):
        ...
        for x in xrange(self.width):
            ...
            self.archivoOutput.write("\n\n") # LINEA AGREGADA 
        self.archivoOutput.close()
        self.newImag.save("mirrorHorizontal",self.imag.format)
        print("Done...")
    ...
    def mirrorVertical(self):
        ...
        self.newImag.save("mirrorVertical",self.imag.format)
        print("Done...")
        self.imprimirMatrizSalida()
    ...
    def threshold(self,threshol):
        ...
        for x in xrange(self.width):
            ...
            self.archivoOutput.write("\n\n") # LINEA AGREGADA 
        self.archivoOutput.close()
        self.newImag.save("threshold",self.imag.format)
        print("Done...")
    ...
    def lightenImagen(self,light):
        ...
        self.newImag.save("lightenImage",self.imag.format)
        print("Done...")
        self.imprimirMatrizSalida()
    ...
    def diagonalShifting(self):
        ...
        self.newImag.save("shiftDiagonal",self.imag.format)
        print("Done...")
        self.imprimirMatrizSalida()
    ...
    def horizontalShifting(self):
        ...
        self.newImag.save("shiftHorizontal",self.imag.format)
        print("Done...")
        self.imprimirMatrizSalida()
    ...
    def verticalShifting(self):
        ...
        self.newImag.save("shiftVertical",self.imag.format)
        print("Done...")
        self.imprimirMatrizSalida()
    ...
    def darkenImage(self,dark):
        ...
        self.newImag.save("darkenImage",self.imag.format)
        print("Done...")
        self.imprimirMatrizSalida()
...
def main():
    ...
    while(op!=12):
        ...
        imageModule=ImageModule(Image.open("1"))
        ...
        if(op==1):
            ...
            while(flag):
                try:
                    ...
                    flag=True
                    print("Write a number my friend")
